export default {
    ...
    设置_基础设置_启动检查更新_标题: 'Проверять обновления при запуске',
    设置_基础设置_启动检查更新_描述: 'При открытии BPM автоматически проверять обновления и кратко показывать количество.',
