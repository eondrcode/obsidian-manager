export default {
    ...
    通知_ID已复制: 'ID copied',
    备注Tooltip_设置标题: 'Note tooltip settings',
    备注Tooltip_启用: 'Enable hover note tooltip',
    备注Tooltip_显示范围: 'Scope',
    备注Tooltip_范围_仅启用: 'Enabled plugins only',
    备注Tooltip_范围_全部: 'All plugins',
    备注Tooltip_范围_仅禁用: 'Disabled plugins only',
    备注Tooltip_范围_按分组: 'By group',
    备注Tooltip_范围_按标签: 'By tag',
    备注Tooltip_标题文本: 'Title text',
    备注Tooltip_最大条数: 'Max items',
    备注Tooltip_默认标题: '📌 Plugin notes',
    备注Tooltip_右键提示: 'Right-click the ribbon icon to customize this tooltip',
}
