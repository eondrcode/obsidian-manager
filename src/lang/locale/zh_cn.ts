export default {
    ...
    分享_导出插件_提示: '导出插件',
    分享_下载插件_提示: '下载插件',
    备注Tooltip_设置标题: '备注 Tooltip 设置',
    备注Tooltip_启用: '启用悬停备注 Tooltip',
    备注Tooltip_显示范围: '显示范围',
    备注Tooltip_范围_仅启用: '仅启用插件',
    备注Tooltip_范围_全部: '全部插件',
    备注Tooltip_范围_仅禁用: '仅禁用插件',
    备注Tooltip_范围_按分组: '按分组',
    备注Tooltip_范围_按标签: '按标签',
    备注Tooltip_标题文本: '标题文本',
    备注Tooltip_最大条数: '最大显示条数',
    备注Tooltip_默认标题: '📌 插件备注',
    备注Tooltip_右键提示: '右键图标可自定义此 Tooltip',
}
